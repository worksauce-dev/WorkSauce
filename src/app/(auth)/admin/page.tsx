...
import { updateVerifyingQueue } from "@/api/firebase/admin/updateVerifyingQueue";
import { VerifyingQueueContainer } from "@/components/admin/VerifyingQueueContainer";
...
export default async function AdminDashboard() {
  ...
  return (
    <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 flex flex-col h-screen gap-4 ">
      ...
      <VerifyingQueueContainer
        pendingQueue={pendingQueue}
        updateVerifyingQueue={updateVerifyingQueue}
      />
    </div>
  );
}
