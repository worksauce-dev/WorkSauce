...
interface SendingTestPageProps {
  params: {
    dashboardId: string;
    testId: string;
  };
...
const SendingTestPage = ({ params }: SendingTestPageProps) => {
  const { testId } = params;
  ...
  switch (testId) {
    case "sauce":
      return <SendingSauceTest user={individualUser} />;
    case "sugar":
      return <SendingSugarTest user={individualUser} />;
    default:
