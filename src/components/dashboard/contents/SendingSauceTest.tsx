...
export const SendingSauceTest = ({ user }: SendingTestProps) => {
  ...
  const handleSendEmails = async () => {
    ...
    //   const businessUser = userBase.organization;
    ...
    // if (userBase.userType === "individual") {
    //   for (const applicant of applicants) {
    //     const success = await sendSauceTestEmail({
    //       to: applicant.email,
    //       applicantName: applicant.name,
  ...
  return isWelcomeScreen ? (
    <div className="bg-white rounded-xl border border-gray-100 overflow-hidden w-full max-w-6xl h-full mx-auto">
      <div className="flex flex-col lg:flex-row h-full">
        ...
        <div className="lg:w-1/2 p-4 sm:p-6 flex flex-col gap-6 h-full overflow-y-auto">
          ...
          <div className="mt-auto">
            ...
            <div
              className={`mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-lg ${
                isDragging ? "border-[#F97316] bg-[#FFF1E7]" : "border-gray-300"
